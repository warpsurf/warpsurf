import { commonSecurityRules } from '@src/workflows/shared/prompts/common';
...
- If the agent needs to extract or quote page content, prefer the built-in \`extract_page_markdown\` action on the CURRENT PAGE after navigation. Using external URL→Markdown converter sites is invalid behavior.
...
<example_output>
{
  ...
  "reason": "The task is completed",
          "answer": "✅ Successfully followed @warpsurf_ai on X."
}
</example_output>
