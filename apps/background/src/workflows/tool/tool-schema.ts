...
/** Region codes accepted by preferredRegion (matches web-settings UI). */
...
/** Maps country names and abbreviations to region codes so users can say "UK" instead of "co.uk". */
