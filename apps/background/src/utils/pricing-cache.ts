...
// Cache generated on 2025-12-22 - Update by running: pnpm generate-pricing-cache
export const CACHED_PRICING_DATA: CachedPricingData = {
  generatedAt: '2025-12-22T21:34:22.839Z',
  version: 1,
  helicone: {
    openai: {
      models: [
  ...
  openRouter: {
    groups: [
      ...
      },
      {
        id: 'arliai',
        displayName: 'Arliai',
        models: ['arliai/qwq-32b-arliai-rpr-v1'],
      },
      {
        id: 'baidu',
        displayName: 'Baidu',
      ...
      },
      {
        id: 'minimax',
        displayName: 'Minimax',
        models: ['minimax/minimax-01', 'minimax/minimax-m1', 'minimax/minimax-m2'],
      },
      {
        id: 'mistralai',
        displayName: 'Mistral',
    ...
    pricing: {
      ...
      'deepseek/deepseek-v3.2': {
        inputPerToken: 2.39e-7,
        outputPerToken: 3.78e-7,
      },
      ...
      'baidu/ernie-4.5-21b-a3b-thinking': {
        inputPerToken: 5.6e-8,
        outputPerToken: 2.24e-7,
      },
      'google/gemini-2.5-flash-image': {
        inputPerToken: 3e-7,
        outputPerToken: 0.0000025,
      ...
      'baidu/ernie-4.5-vl-28b-a3b': {
        inputPerToken: 1.12e-7,
        outputPerToken: 4.48e-7,
      },
      'z-ai/glm-4.5v': {
        inputPerToken: 4.8e-7,
        outputPerToken: 0.00000144,
      },
      'ai21/jamba-mini-1.7': {
        inputPerToken: 2e-7,
        outputPerToken: 4e-7,
      ...
      'moonshotai/kimi-k2': {
        inputPerToken: 4.56e-7,
        outputPerToken: 0.00000184,
      },
      'thudm/glm-4.1v-9b-thinking': {
        inputPerToken: 2.8e-8,
        outputPerToken: 1.104e-7,
      },
      'mistralai/devstral-medium': {
        inputPerToken: 4e-7,
        outputPerToken: 0.000002,
      ...
      'baidu/ernie-4.5-vl-424b-a47b': {
        inputPerToken: 3.36e-7,
        outputPerToken: 0.000001,
      },
      'baidu/ernie-4.5-300b-a47b': {
        inputPerToken: 2.24e-7,
        outputPerToken: 8.8e-7,
      },
      'inception/mercury': {
        inputPerToken: 2.5e-7,
