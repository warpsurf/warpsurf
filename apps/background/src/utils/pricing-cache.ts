...
// Cache generated on 2026-03-27 - Update by running: pnpm generate-pricing-cache
export const CACHED_PRICING_DATA: CachedPricingData = {
  generatedAt: '2026-03-27T11:23:35.231Z',
  version: 1,
  helicone: {
    openai: {
      models: [
