...
import { FaTrash, FaPen, FaCheck, FaTimes, FaChevronRight, FaBrain, FaSearch, FaRobot, FaRandom } from 'react-icons/fa';
    ...
    <div className="p-2">
      <div className="mb-1 flex items-center justify-between">
        ...
        {isExpanded && (
          <button
            ...
            className={`rounded-md px-2 py-0.5 text-xs font-medium ${isDarkMode ? 'bg-slate-700 text-gray-200 hover:bg-slate-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
            + Add frequently used
          </button>
        )}
      </div>

      {isExpanded && bookmarks.length > 8 && (
      ...
      {isExpanded && (
        <div className="flex flex-wrap gap-2">
          {editingId === 0 && (
            <div
              className={`rounded-lg p-3 ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-sky-100'} border`}>
                  ...
                  <div className="flex items-center">
                    <button
                      ...
                      {(() => {
                        ...
                        return (
                          <span
                            className={`inline-flex max-w-full items-center justify-between gap-2 rounded-full px-2 py-1 text-xs font-medium shadow-sm ${colorClasses}`}>
