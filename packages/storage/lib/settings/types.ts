...
export const llmProviderDefaultModels = {
  ...
  [ProviderTypeEnum.Anthropic]: {
    [AgentNameEnum.AgentPlanner]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.MultiagentPlanner]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.MultiagentWorker]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.AgentNavigator]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.AgentValidator]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.Auto]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.Chat]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.Search]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.MultiagentRefiner]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.HistorySummariser]: 'claude-sonnet-4-5-20250929',
    [AgentNameEnum.Estimator]: 'claude-haiku-4-5-20251001',
  },
  [ProviderTypeEnum.Gemini]: {
